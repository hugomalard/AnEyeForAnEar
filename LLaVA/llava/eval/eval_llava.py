...
def eval_model(args):
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(
        args.model_path, args.model_base, model_name,audio='laion/clap-htsat-unfused',modality='audio_vis'
    )
    model.mask = 0
    qs = args.query
    ...
    audio,sr=torchaudio.load('/tsi/audiosig/audible/dcase/studies/011_AudioSet_pseudolabeling/002_CLAP_labeling/tmp_audios/audio_19_0.wav')
    if sr != 48000:
