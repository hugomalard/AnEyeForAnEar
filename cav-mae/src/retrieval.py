    ...
    with torch.no_grad():
        for i, (a_input, v_input, labels) in enumerate(val_loader):
            ...
            with autocast():
                ...
                x, mask_a, ids_restore_a, mask_v, ids_restore_v, audio_output, video_output = audio_model.module.forward_encoder(audio_input, video_input, 0, 0, mask_mode='unstructured')
...
model = '/home/ids/hmalard/CAV-MAE-SCALE.pth' #'/home/ids/hmalard/baseline/contrastiveBatch256/models/best_audio_model.pth'#
res = []

# for audioset
for direction in ['video', 'audio']:
    #data = '/home/ids/hmalard/retrievalAS2.json'
    data = '/home/ids/hmalard/audible/protected/dev/dcase/studies/010_CAV_MAE_filtering/preproc/ASEvalRetriev.json'
...
'''# for vggsound
for direction in ['video', 'audio']:
    data = '/home/ids/hmalard/retrievalVGG2.json'
